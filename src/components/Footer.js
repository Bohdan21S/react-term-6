        ...
        <Row>
          ...
          <Col md={4} className="mb-4 mb-md-0">
            ...
            <ul className="list-unstyled">
              ...
              <li><a href="/movies" className="text-white">Фільми</a></li>
              <li><a href="/schedule" className="text-white">Розклад сеансів</a></li>
        ...
        <Row className="mt-3">
          <Col>
            <p className="text-center">
              &copy; {new Date().getFullYear()} Кінотеатр "Назва вашого кінотеатру". Усі права захищені.
            </p>
          </Col>
        </Row>
      </Container>
