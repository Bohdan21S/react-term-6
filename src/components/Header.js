...
const Header = () => {
  return (
    <Navbar bg="dark" variant="dark" expand="lg" id='h'>
      <Container>
        <Navbar.Brand as={Link} to="/home">Кінотеатр "Sexy Me"</Navbar.Brand>
        <Navbar.Toggle aria-controls="basic-navbar-nav" />
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            <Nav.Link as={Link} to="/about">Про нас</Nav.Link>
            <Nav.Link as={Link} to="/movies">Фільми</Nav.Link>
            <Nav.Link as={Link} to="/schedule">Розклад</Nav.Link>
          ...
          <Nav>
            ...
            <Nav.Link as={Link} to="/signup">Зареєструватися</Nav.Link>
          </Nav>
        </Navbar.Collapse>
      </Container>
    </Navbar>
